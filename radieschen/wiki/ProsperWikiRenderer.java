/**
 * This is a Wiki Renderer which generates output for the prosper 
...
public class ProsperWikiRenderer extends LatexBaseWikiRenderer {
	 ...
	 * @throws IOException
	 */
	public ProsperWikiRenderer()throws IOException{
		super("/radieschen/wiki/prosper.prop");
		slideOpen = false;
	}
	/**
	...
	public void export(String page, String targetDir, RadiDatabase db, 
		...
		templateFile = dbDir + File.separatorChar + "prosper.template";
